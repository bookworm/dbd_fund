...
working_directory "/home/root/fund.designbreakdown.com/dbd_fund" 

# Listen on a Unix domain socket, use the default backlog size
listen "/tmp/dbd_fund.sock", :backlog => 1024

# Nuke workers after 30 seconds instead of 60 seconds (the default)
timeout 30

# Lets keep our process id's in one place for simplicity  
pid "/home/root/fund.designbreakdown.com/dbd_fund/pids/unicorn.pid"
